...
public class ArcRenderer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        spacingScale = Screen.width / baseScreenWidth; //scales dot spacing based on width of the current screen
    }
    ...
    void Update()
    {
        ...
        EnemyTarget target = FindLockOnEnemy(mousePos);
        if (target != null)
        {
            mousePos = target.GetLockOnPoint();           
        }
